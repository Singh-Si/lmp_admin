...
const Faq = () => {
    ...
    const handlesubmit = async (e) => {
        ...
        try {
            ...
            await fetch(`https://lmp.handsintechnology.in/api/addfaqContent`, {
                method: 'POST',
                headers: {
    ...
    const getfaqdata = async () => {
        try {
            ...
            await fetch(`https://lmp.handsintechnology.in/api/getfaqContent`, requestOptions)
                .then(response => response.json())
                .then(data => {
                    console.log('Success:', data);
                    if (data.status == 200) {
    ...
    const getfaqbyid = async (id) => {
        try {
            ...
            const result = await fetch(`https://lmp.handsintechnology.in/api/getfaqContentById?id=${id}`, requestOptions)
    ...
    const handleupdate = async (e) => {
        ...
        try {
            ...
            await fetch(`https://lmp.handsintechnology.in/api/editfaqContent?id=${faqId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
    ...
    const deleteItem = async (id) => {
        try {
            await fetch(`https://lmp.handsintechnology.in/api/deletefaqContent?id=${id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
