...
const YachtPage = () => {
  ...
  const getYachtContent = async () => {
    try {
      ...
      await fetch('https://lmp.handsintechnology.in/api/getYachtContent', requestOptions)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://lmp.handsintechnology.in/api/editYachtContent', requestOptions);
