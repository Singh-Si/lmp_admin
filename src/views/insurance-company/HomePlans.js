...
function HomePlans({ companyId }) {
  ...
  const getHomePlans = async (companyId, page, perPage) => {
    ...
    await fetch(`https://lmp.handsintechnology.in/api/getHomePlansInsurance`, requestOptions)
  ...
  const handleFileuploads = async (e) => {
    ...
    await fetch("https://lmp.handsintechnology.in/api/upload_home_plan_policywordings_file", requestOptions)
