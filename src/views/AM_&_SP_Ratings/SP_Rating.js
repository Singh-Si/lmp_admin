...
const SP_Ratings = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`https://lmp.handsintechnology.in/api/addspRating`, reqdata)
            .then((data) => {
                if (data.status == 201) {
                    setShowModal(false)
                    swal({
    ...
    const updatestatus = async (id, status) => {
        ...
        axios.post('https://lmp.handsintechnology.in/api/updatespRatingStatus', data)
            .then((data) => {
                if (data.status == 200) {
                    setShowModal(false)
                    getAll_AM_Ratings(page, perPage)
    ...
    const getAll_AM_Ratings = (page, perPage) => {
        ...
        try {
            axios.get(`https://lmp.handsintechnology.in/api/getAllspRatings?page=${page}&perPage=${perPage}`)
                // .then((res) => res.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const getSingleRating = (id) => {
        try {
            axios.get(`https://lmp.handsintechnology.in/api/getSingleSpRating/${id}`)
                // .then((res) => res.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const handleUpdate = (e) => {
        ...
        axios.put(`https://lmp.handsintechnology.in/api/UpdateSpRating/?id=${updateId}`, reqdata)
            // .then((res) => res.json())
            .then((data) => {
                if (data.status == 200) {
