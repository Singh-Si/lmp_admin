...
const Updateyachthorsepowerlist = () => {
  ...
  const [yacht_horsepower_type_location, setYachthorsetypelocation] = useState([]);
  ...
  const detailsbyid = async () => {
    ...
    setYachthorsetype(result.yacht_horsepower_type);
    setYachthorsetypestatus(result.yacht_horsepower_type_status);
    const locationid = result.yacht_horsepower_type_location;
      ...
      fetch(`https://lmp.handsintechnology.in/api/get_location_by_id/${location_id[i]}`, requestOptions)
        ...
        .then((data) => {
          ...
          if (location_name_len === location_id_len) {
            ...
            setYachthorsetypelocation(location_name_arr_obj);
          }
        });
    }
    locationList();
  ...
  const updateyachthorsepower = async (e) => {
    e.preventDefault();
    if (yacht_horsepower_type === '' || yacht_horsepower_type === null) {
      swal("Please Enter Horse Power", "", "warning")
      return false;
    }
    if (yacht_horsepower_type_location === '' || yacht_horsepower_type_location === null) {
      swal("Please Select Location", "", "warning")
      return false;
    }
    if (yacht_horsepower_type_status === '' || yacht_horsepower_type_status === null) {
      ...
      let result = await fetch(`https://lmp.handsintechnology.in/api/update_Yacht_horespower_type_details`, {
        method: "POST",
        body: JSON.stringify({ ParamValue: ParamValue, yacht_horsepower_type: yacht_horsepower_type, yacht_horsepower_type_location: yacht_horsepower_type_location_str.toString(), yacht_horsepower_type_status: yacht_horsepower_type_status }),
        headers: {
          "Content-Type": "application/json",
        },
      });
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Horse Power List</h4>
              </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <input type='text' className="form-control"
                        ...
                        onChange={e => setYachthorsetype(e.target.value)}
                      />
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                      ...
                      <select className="form-control" name="status" onChange={(e) => setYachthorsetypestatus(e.target.value)}>
                        <option defaultValue={yacht_horsepower_type_status} hidden>{yacht_horsepower_type_status == 1 ? 'Active' : 'InActive'}</option>
...
export default Updateyachthorsepowerlist