...
const ViewBoatBreadth = () => {
    ...
    const getBoatBreadth = (page, perPage) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/boaBreadth?limit=${perPage}&page=${page}`, requestOptions)
    ...
    const add_Boat_Breadth = (e) => {
        try {
            ...
            fetch('https://lmp.handsintechnology.in/api/boaBreadth', requestOptions)
                .then(response => response.json())
                .then(data => {
                    setShowModal(false);
                    if (data.status === 201) {
    ...
    const deleteItem = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/deleteYachtMaster?id=${id}&type=boatBreadth`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
    ...
    const GetBoatBreadthById = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/boaBreadthBYId?id=${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const updateBoatBreadth = (e) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/boaBreadth?id=${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
