...
const YachtMake = () => {
    ...
    const getlistMakeMotor = (page, perPage) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/getYachtMake?page=${page}&limit=${perPage}&name=${searchvalue}&status=${statusvalue}`, requestOptions)
    ...
    const updateYachtStatus = (id, status) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/UpdateYachtMakeStatus?id=${id}&status=${status}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
    ...
    const makeMotorDetails = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/getYachtMake_details?id=${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const updateSubmit = (e) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/updateYachtMake?id=${make_motor_id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
    ...
    const deleteItem = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/deleteYachtMaster/?id=${id}&type=YachtMake`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
                                                ...
                                                <>
                                                    {
                                                        data.map((item, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td>{<img src={`https://lmp.handsintechnology.in/YachtMakeLogos/${item.logo}`} alt='image' height={100} width={100} />}</td>
