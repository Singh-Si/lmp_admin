                        ...
                        <div className="card-header">
                            <div className="row">
                                <div className="col-md-6">
                                    <h4 className="card-title">Add Yacht Condition</h4>
                                </div>
                                <div className='col-md-6'>
                                    <a href={`/Viewyachtcondition`} className="btn btn-primary" style={{ float: "right" }}>Back</a>
                                </div>
                            </div>
                        </div>
...
export default AddYachtConditions