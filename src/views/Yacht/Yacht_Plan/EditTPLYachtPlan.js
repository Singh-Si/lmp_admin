...
const EditTPLYachtPlan = () => {
    const navigate = useNavigate();
    const [rowsData, setRowsData] = useState({});
    const [planCategory, setPlanCategory] = useState([]);
    const [natureOfPlan, setNatureOfPlan] = useState([]);
    const [bodyType, setBodyType] = useState([]);
    const [min_premium, setMinPremium] = useState('');
    const [premiumedit, setPremiumedit] = useState('');
    ...
    const getBoatBreadth = () => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/activeboaBreadth`, requestOptions)
    ...
    const BodyType = () => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/getyachtbodytype`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const Engine_Type = () => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/get_Yacht_engine_type_list`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const Speed_Knot = () => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/get_Yacht_speed_knot_typeList`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const yacht_hull_material = () => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/get_Yacht_hull_materials`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const yacht_plan_details = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/yacht_plan_details/${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                ...
                for (let i = 0; i < y_b_type.length; i++) {
                    ...
                    body_type_obj.push({
                        ...
                        minimum_premium: y_b_type[i]['minimum_premium'],
                        premium: y_b_type[i]['primium']

                    });
                    min_prim_arr.push({ min_prim: y_b_type[i]['minimum_premium'] });
                    premiumarr.push({ prim: y_b_type[i]['primium'] });
                }
                ...
                const uniqminPrim = removeDuplicateObjects(min_prim_arr, 'min_prim');
                const uniqpremium = removeDuplicateObjects(premiumarr, 'prim');
                const parr = [];
                const minarr = [];
                for (let index = 0; index < uniqminPrim.length; index++) {
                    minarr.push(uniqminPrim[index]?.min_prim);
                    parr.push(uniqpremium[index]?.prim);

                }
                console.log("uniqminPrim>>>>", uniqminPrim)
                console.log("uniqpremium>>>>", uniqpremium)
                var y_b_topup_values = y_b_type_topup_obj.join(",")
                var min_premium_values = minarr.join(",");
                var premium_values = parr.join(",");
                setMinPremium(min_premium_values);
                setPremiumedit(premium_values);
                setChangedBodyType(uniqueBodyTypes)
    ...
    const handleSubmit = (e) => {
        ...
        const HorsePower = changedHorsePower;
        ...
        // const measurementType = data.get('measurement');`
        ...
        fetch(`https://lmp.handsintechnology.in/api/updateYachtplan/${yacht_plan_id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    Swal.fire({
                        ...
                        <div className="card-body">
                            ...
                            >
                                ...
                                <div className="row">
                                    ...
                                    {/* <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            ...
                                            <input required type="text" name="body_type_ptopup" className="form-control" placeholder="Enter Topup (Yacht body type)" autoComplete="off" defaultValue={bodyTypeTopup} />
                                        </div>
                                    </div> */}
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            <label className='text-danger'>Boat Length</label>
                                            <input required type="text" name="measurement_value" className="form-control" placeholder="Enter Boat Lenght Values" autoComplete="off" defaultValue={measurementValues.measurementValue} />
                                        </div>
                                    </div>
                                    {/* <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            <label>Topup(Boat Length)</label>
                                            <input required type="text" name="measurement_topup" className="form-control" placeholder="Enter Topup (MEASUREMENT)" autoComplete="off" defaultValue={measurementValues.measurementtopups} />
                                        </div>
                                    </div> */}
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            <label className='text-danger'>Premium</label>
                                            <input required type="text" name="premium" className="form-control" placeholder="Enter Premium" autoComplete="off" defaultValue={premiumedit} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            ...
                                            <input required type="text" name="minimum_premium" className="form-control" placeholder="Enter Minimum Premium" autoComplete="off" defaultValue={min_premium} />
                                        </div>
                                    </div>
                                    {/* <div className="col-md-4">
                                        <div className="form-group mb-3">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label className='text-danger'>Fixed/Percentage/Reffered(Hull Materail)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label className='text-danger'>Fixed/Percentage/Reffered(ENGINETYPE)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered(HULL AND EQUIPMENT VALUE RANGE)</label>
                                            <input type="text" name="hull_and_eqp_topup" className="form-control" placeholder="Enter Topup (Hull and equipment value range)" autoComplete="off" defaultValue={HullEqp?.hulltopups} />
                                        </div>
                                    </div>
                                </div>
                                <div className='row'>
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            ...
                                            <Multiselect
                                                ...
                                                options={breadthList}
                                                selectedValues={defualtboatbreadth}
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            ...
                                            <input required type="text" name="boat_horsepower" className="form-control" placeholder="Enter Boat Horsepower" autoComplete="off" defaultValue={horsePower?.horse_power} />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered(Speed Knots)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered (DINGHY/TENDER VALUE RANGE)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered (Outboard value range)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered (Personal Effects including Cash)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered (Trailer)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered(PASSENGER CAPACITY)</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            <label>Fixed/Percentage/Reffered(CREW CAPACITY)</label>
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            ...
                                            <input required type="text" name="add_op_con_desc" onInput={(e) => validateInput(e)} className="form-control" placeholder="Enter Add Option Condition Description" autoComplete="off" defaultValue={Addopcondesc.addopcondescValues} />
                                    ...
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            ...
                                            <input required type="text" name="vat" onInput={(e) => validateInput(e)} className="form-control" placeholder="Enter Vat Able" autoComplete="off" defaultValue={Addopcondesc.vat} />
...
export default EditTPLYachtPlan
