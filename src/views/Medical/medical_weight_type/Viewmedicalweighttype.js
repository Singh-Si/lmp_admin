...
const Viewmedicalweighttype = () => {
  ...
  const getmedicalweighttype = async (page, perPage) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/get_medical_weight_type?page=${page}&limit=${perPage}`, requestOptions)
  ...
  const exportlistdata = () => {
    ...
    fetch('https://lmp.handsintechnology.in/api/get_medical_weight_type', requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const updatestatus = async (id, medical_weight_type_status) => {
    let result = await fetch('https://lmp.handsintechnology.in/api/update_medical_weight_type_status', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const collectExceldata = async (e) => {
    ...
    let result = await fetch("https://lmp.handsintechnology.in/api/read_medical_weight_type_excel ",
      {
        method: "post",
        body: fd,
      })
  ...
  const addmedicalweighttype = async (e) => {
    ...
    let result = await fetch('https://lmp.handsintechnology.in/api/add_medical_weight_type', {
      method: 'post',
      body: JSON.stringify({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/deleteMedicalMaster/?id=${id}&type=weightType`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
