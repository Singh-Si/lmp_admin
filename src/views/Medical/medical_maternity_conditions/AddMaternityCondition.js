...
const AddMaternityCondition = () => {
    ...
    const handleSubmit = (e) => {
        ...
        try {
            ...
            fetch('https://lmp.handsintechnology.in/api/maternity', requestOptions)
                .then(response => response.json())
                .then(data => {
                    if (data.status == 200) {
                        swal({
                ...
                <div className="col-md-12">
                    <div className="card">
                        <div className="card-header">
                            <div className="row">
                                <div className="col-md-12">
                                    <h4 className="card-title">Add Maternity Condition</h4>
                                </div>
                            </div>
                                            ...
                                            rowsData.map((data, index) => {
                                                return (
                                                    <tr key={index} >
                                                        ...
                                                        <td>
                                                            <input type="text" onChange={(evnt) => (handleChange(index, evnt))} className="form-control" name="condition" placeholder="Condition" autoComplete="off" required />
...
export default AddMaternityCondition