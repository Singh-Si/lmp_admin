...
const UnderwrintingConditions = () => {
    ...
    const geTableBenefits = async (page, perPage) => {
        ...
        await fetch(`https://lmp.handsintechnology.in/api/get_Underwriting_condition?page=${page}&limit=${perPage}`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const updatestatus = async (id, status) => {
        let result = await fetch('https://lmp.handsintechnology.in/api/update_Underwriting_condition_status', {
            method: 'post',
    ...
    const AddUnderwritingCondition = async (e) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/add_Underwriting_condition`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    setShowModal(false);
    ...
    const updateSubmit = (e) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/update_Underwriting_condition`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
    ...
    const exportlistdata = () => {
        ...
        fetch('https://lmp.handsintechnology.in/api/get_Underwriting_condition', requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const collectExceldata = async (e) => {
        ...
        let result = await fetch("https://lmp.handsintechnology.in/api/read_underwriting_condition_excel",
            {
                method: "POST",
                body: fd,
            });
    ...
    const detailsbyid = async (ParamValue) => {
        ...
        let result = await fetch(`https://lmp.handsintechnology.in/api/get_Underwriting_conditionbyid`, requestOptions);
        result = await result.json();
    ...
    const deleteItem = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/deleteMedicalMaster/?id=${id}&type=underwritingConditions`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
