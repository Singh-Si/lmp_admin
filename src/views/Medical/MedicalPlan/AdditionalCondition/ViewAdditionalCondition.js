...
const ViewAdditionalUnderwrinting = () => {
  ...
  const getAdditionalConditions = async (id) => {
    ...
    await fetch(`https://lmp.handsintechnology.in/api/get_additional_conditions`, requestOptions)
  ...
  const handleSubmit = (e) => {
    ...
    if (hasNoStatus) {
      ...
      fetch(`https://lmp.handsintechnology.in/api/add_Additional_underwriting_conditions`, requestOptions)
        .then(response => response.json())
        .then(data => {
