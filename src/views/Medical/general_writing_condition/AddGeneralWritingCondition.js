...
const AddGeneralWritingCondition = () => {
    ...
    const handleSubmit = (e) => {
        ...
        try {
            ...
            fetch('https://lmp.handsintechnology.in/api/generalWrittingCondition', requestOptions)
                .then(response => response.json())
                .then(data => {
                    if (data.status == 200) {
                        swal({
                        ...
                        navigate('/ViewGeneralwritingConditions')
                        setTimeout(() => {
                            swal.close()
                        }, "1000");
                    }
...
export default AddGeneralWritingCondition