...
const Viewmedicalplancondition = () => {
  ...
  const getmedicalplancondition = async (page, perPage) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/get_medical_plan_condition?page=${page}&limit=${perPage}`, requestOptions)
  ...
  const exportlistdata = () => {
    ...
    fetch('https://lmp.handsintechnology.in/api/get_medical_plan_condition', requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const updatestatus = async (id, medical_plan_condition_status) => {
    let result = await fetch('https://lmp.handsintechnology.in/api/update_medical_plan_condition_status', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const collectExceldata = async (e) => {
    ...
    let result = await fetch("https://lmp.handsintechnology.in/api/read_medical_plan_condition_excel ",
      {
        method: "post",
        body: fd,
      })
  ...
  const addmedicalPlanCondition = async (e) => {
    ...
    let result = await fetch('https://lmp.handsintechnology.in/api/add_medical_plan_condition', {
      method: 'POST',
      body: JSON.stringify({
  ...
  const detailsbyid = async (ParamValue) => {
    ...
    let result = await fetch(`https://lmp.handsintechnology.in/api/get_medical_plan_condition_detailsbyid`, requestOptions);
    result = await result.json();
  ...
  const updatemedicalplancondition = async (e) => {
    ...
    let result = await fetch(`https://lmp.handsintechnology.in/api/update_medical_plan_condition_details`, {
      method: "POST",
      body: JSON.stringify({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/deleteMedicalMaster/?id=${id}&type=planCondition`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
