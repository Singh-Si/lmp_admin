...
const ViewBusinessEntityBank = () => {
    ...
    const getlistBank = (page, perPage) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/get_business_entity_bank/${page}/${perPage}`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('https://lmp.handsintechnology.in/api/add_business_entity_bank', requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
    ...
    const editbank = (bankid) => {
        ...
        fetch('https://lmp.handsintechnology.in/api/get_business_entity_bank_details', requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
    ...
    const updateSubmit = (e) => {
        ...
        fetch('https://lmp.handsintechnology.in/api/update_business_entity_bank', requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
    ...
    const updateStatus = (bankid, status) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/update_business_entity_bank_status/${bankid}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
...
export default ViewBusinessEntityBank
