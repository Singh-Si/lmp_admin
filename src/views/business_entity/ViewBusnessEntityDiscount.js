...
const ViewBusinessEntityDiscount = () => {
    ...
    const getlistBecommission = (page, perPage) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/getAllBusinessEntityDiscounts?page=${page}&limit=${perPage}`, requestOptions)
    ...
    const handleSubmit = (e) => {
        try {
            ...
            if (selectedcompany.length == 0 || selectedcompany == undefined) {
                ...
                fetch(`https://lmp.handsintechnology.in/api/addBusinessEntityDiscount`, requestOptions)
                    .then(response => response.json())
                    .then(data => {
                        if (data.status == 201) {
                            setShowModal(false);
    ...
    const UpdateStatus = (id, status) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/UpdateBusinessEntityDiscountStatus`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
    ...
    const becommissiondetails = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/getSingleBusinessEntityDiscount?id=${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const updateSubmit = (e) => {
        ...
        if (locationdata.length == 0 || locationdata == [] || locationdata == undefined) {
            ...
            fetch(`https://lmp.handsintechnology.in/api/UpdateBusinessEntityDiscount?id=${be_id}`, requestOptions)
                .then(response => response.json())
                .then(data => {
                    if (data.status === 200) {
    ...
    const deleteItem = async (id) => {
        ...
        await fetch(`https://lmp.handsintechnology.in/api/deleteMasterData?id=${id}&type=bediscount`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
