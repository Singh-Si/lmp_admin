...
const Viewhomeplanytypelist = () => {
  ...
  const gethomeplantype = async (page, perPage) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/get_home_plan_type?page=${page}&limit=${perPage}`, requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const exportlistdata = () => {
    ...
    fetch('https://lmp.handsintechnology.in/api/get_home_plan_type', requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const updatestatus = async (id, home_plan_type_status) => {
    let result = await fetch('https://lmp.handsintechnology.in/api/update_home_plan_type_status', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const collectExceldata = async (e) => {
    ...
    await fetch("https://lmp.handsintechnology.in/api/read_home_plan_type_excel ",
      {
        method: "post",
        body: fd,
      })
  ...
  const addplantype = async (e) => {
    ...
    await fetch('https://lmp.handsintechnology.in/api/add_home_plan_type', {
      method: 'post',
      body: JSON.stringify({
  ...
  const detailsbyid = async (ParamValue) => {
    ...
    let result = await fetch(`https://lmp.handsintechnology.in/api/get_home_plan_type_detailsbyid`, requestOptions);
    result = await result.json();
  ...
  const updateHomeplantypelist = async (e) => {
    ...
    await fetch(`https://lmp.handsintechnology.in/api/update_home_plan_type_details`, {
      method: "POST",
      body: JSON.stringify({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/deleteHomeMaster/?id=${id}&type=homeplantype`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
