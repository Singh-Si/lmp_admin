...
const HomeAdditionalConditions = () => {
    ...
    const getAdditionalHomeConditions = async (page, perPage) => {
        ...
        await fetch(`https://lmp.handsintechnology.in/api/homeAdditionalConditions?page=${page}&limit=${perPage}`, requestOptions)
    ...
    const updatestatus = async (id, status) => {
        let result = await fetch(`https://lmp.handsintechnology.in/api/homeAdditionalCondition?id=${id}`, {
            method: 'put',
    ...
    const updateSubmit = (e) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/homeAdditionalCondition?id=${UnderwringConditionId}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
    ...
    const detailsbyid = async (ParamValue) => {
        ...
        let result = await fetch(`https://lmp.handsintechnology.in/api/homeAdditionalCondition?id=${ParamValue}`, requestOptions);
        result = await result.json();
    ...
    const deleteItem = (id) => {
        ...
        fetch(`https://lmp.handsintechnology.in/api/deleteHomeMaster/?id=${id}&type=HomeAdditionalCondition`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
