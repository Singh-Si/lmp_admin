...
const ViewCompliance = () => {
  ...
  const getcompliance = (page, perPage) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/customerComplaints?limit=${perPage}&page=${page}`, requestOptions)
  ...
  const updatestatus = async (id, status) => {
    ...
    let result = await fetch('https://lmp.handsintechnology.in/api/updateComplaints', {
      method: 'put',
  ...
  const getEmailTemplate = () => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/getSpecificEmailTemplates?type=complaint`, requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const sendEmail = () => {
    ...
    // return false;
    fetch('https://lmp.handsintechnology.in/api/UpdateComplaintStatus', {
      method: 'put',
      body: fd,
      headers: {
    ...
    <>
      <Container>
        <div className="card mb-4">
          <div className="card-header">
            <div className="row">
              <div className="col-md-6">
                <h4 className="card-title">Compliance & IT</h4>
              </div>
              {/* <div className="col-md-6">
          ...
          <Tabs defaultActiveKey={'Complaints'} id="uncontrolled-tab-example" className="bg-light mb-3">
                      ...
                      data?.length > 0 ?
                        data.map((item, index) =>
                          <tr key={index}>
                            ...
                            <td>{item.message}</td>
                            <td>{item.lobDetails[0]?.line_of_business_name}</td>
