...
const ViewGender = () => {
  ...
  const getGender = (page, limit) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/getGender?page=${page}&limit=${limit}`, reqOptions)
      .then(response => response.json())
      .then(data => {
        setGender(data.data)
  ...
  const AddGender = (e) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/addGender`, reqOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status == 201) {
          getGender(page, perPage);
  ...
  const goTosetShowEditModal = (id) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/getGenderbyid?id=${id}`, reqOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const EditGender = (e) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/updateGender?id=${editData?._id}`, reqOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status == 200) {
  ...
  const ActivateDeactivate = (id, status) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/updateGender?id=${id}`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status == 200) {
          swal({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/deleteGroupMedicalMaster?id=${id}&type=Gender`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
