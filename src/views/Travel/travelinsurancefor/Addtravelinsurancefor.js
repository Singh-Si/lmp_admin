    ...
    const handleSubmit = (e) => {
        ...
        try {
            const hasEmptyFields = rowsData.some((row) => {
                return row.travel_insurance_for.trim() === '' || row.location == 0;
            });
            ...
            if (hasEmptyFields) {
                ...
                fetch(`https://lmp.handsintechnology.in/api/travelinsurancefor`, requestOptions)
                    .then(response => response.json())
                    .then(data => {
                        if (data.status == 200) {
                            swal({
                ...
                <div className="col-md-12" >
                    <div className="card" >
                        <div className="card-header">
                            <div className="row">
                                <div className="col-md-12">
                                    <h4 className="card-title">Add Travel Insurance For </h4>
                                </div>
                            </div>
                        </div>
                                        ...
                                        rowsData.map((data, index) => {
                                            return (
                                                <tr key={index} >
                                                    ...
                                                    <td>
                                                        <input type="text" onChange={(evnt) => (handleChange(index, evnt))} className="form-control" name="travel_insurance_for" placeholder="Travel Insurance For" autoComplete="off" required />
...
export default Addtravelinsurancefor
