...
const Viewtravelcovertypelist = () => {
  ...
  const gettravelcovertypelist = async (page, perPage) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/get_travel_cover_type_list/?page=${page}&limit=${perPage}`, requestOptions)
  ...
  const exportlistdata = () => {
    ...
    fetch('https://lmp.handsintechnology.in/api/get_travel_cover_type_list', requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const updatestatus = async (id, travel_cover_type_status) => {
    ...
    await fetch('https://lmp.handsintechnology.in/api/update_travel_cover_type_list_status', {
      method: 'post',
  ...
  const collectExceldata = async (e) => {
    ...
    await fetch("https://lmp.handsintechnology.in/api/read_travel_cover_type_list_excel",
      {
        method: "post",
        body: fd,
      })
  ...
  const addtravelcovertypelist = async (e) => {
    ...
    await fetch('https://lmp.handsintechnology.in/api/add_travel_cover_type_list', {
      method: 'post',
      body: JSON.stringify({
  ...
  const detailsbyid = async (ParamValue) => {
    ...
    let result = await fetch(`https://lmp.handsintechnology.in/api/get_travel_cover_type_list_id`, requestOptions);
  ...
  const updateTravelcovertypelist = async (e) => {
    ...
    await fetch(`https://lmp.handsintechnology.in/api/update_travel_cover_type_list_details`, {
      method: "POST",
      body: JSON.stringify({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://lmp.handsintechnology.in/api/deleteTravelMaster/?id=${id}&type=travelcover`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
